...
all_hh_aggr <- read.csv("path")

# hourly aggregation
all_hr_aggr <- read.csv("path")

# daily aggregation
all_d_aggr <- read.csv("path")

# weekly aggregation
all_week_aggr <- read.csv("path")

# monthly aggregation
all_month_aggr <- read.csv("path")

# annual aggregation
all_yr_aggr <- read.csv("path")
...
# all sites (raw data, i.e., chamber and EC data have not been aggregated), including predictors

# with duplicated EC and salinity
all_sites_pred_dupl <- read.csv("path")
 
# without duplicated EC
all_sites_pred_no_dupl <- read.csv("path")

# all data with chambers aggregated (no temporal aggregation)

all_sites_preds_chaggr <- read.csv("path")
